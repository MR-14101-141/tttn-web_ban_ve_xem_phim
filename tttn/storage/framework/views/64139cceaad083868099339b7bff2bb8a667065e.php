        ...
        <div>
            <form method='get' style="background-color:white">
                ...
                <select id="select_item" name="select_item" class="search__sort" tabindex="0">
                    <option value="<?php echo e(URL::to('/dsphim','all')); ?>">Tất cả</option>
...
<?php echo $__env->make('layout_KH', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH O:\wamp64\www\tttn-tonghop\tttn\resources\views/KH/dsPhim.blade.php ENDPATH**/ ?>