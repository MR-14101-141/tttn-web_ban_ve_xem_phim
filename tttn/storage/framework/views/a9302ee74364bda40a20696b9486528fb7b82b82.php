...
?>
                    ...
                    <div aria-labelledby="userInfo" class="dropdown-menu"><a
                            href="<?php echo e(URL::to('/profileadmin',Session::get('idNV'))); ?>" class="dropdown-item"><strong
...
?></strong><small>
                        ...
                        <div class="dropdown-divider"></div><a href="<?php echo e(url('/')); ?>" class="dropdown-item">Trang chủ</a>
                        <div class="dropdown-divider"></div><a href="<?php echo e(URL::to('/logoutadmin')); ?>"
    ...
    <div class="d-flex align-items-stretch">
        <div id="sidebar" class="sidebar">
            <ul class="sidebar-menu list-unstyled">
                <li class="sidebar-list-item"><a href="<?php echo e(url('/phim')); ?>" class="sidebar-link text-dark"><i
                            class="o-table-content-1 mr-3 text-gray"></i><span>Quản Lý Phim</span></a></li>
                <li class="sidebar-list-item"><a href="<?php echo e(url('/dsve')); ?>" class="sidebar-link text-dark"><i
                            class="o-table-content-1 mr-3 text-gray"></i><span>Quản Lý Vé</span></a></li>
                <li class="sidebar-list-item"><a href="<?php echo e(url('/lichchieu')); ?>" class="sidebar-link text-dark"><i
                            class="o-survey-1 mr-3 text-gray"></i><span>Quản Lý Lịch Chiếu</span></a></li>
                <li class="sidebar-list-item"><a href="<?php echo e(url('/dskm')); ?>" class="sidebar-link text-dark"><i
                            class="o-survey-1 mr-3 text-gray"></i><span>Quản Lý Khuyến Mãi</span></a></li>
                <li class="sidebar-list-item"><a href="<?php echo e(URL::to('/quanlykh')); ?>" class="sidebar-link text-dark"><i
                            class="o-survey-1 mr-3 text-gray"></i><span>Quản Lý Người Dùng</span></a></li>
                <li class="sidebar-list-item"><a href="<?php echo e(URL::to('/logoutadmin')); ?>" class="sidebar-link text-dark"><i
                            class="o-exit-1 mr-3 text-gray"></i><span>Đăng xuất</span></a></li>
            </ul>

        </div>
        <?php echo $__env->yieldContent('dscuanv'); ?>
    </div>
...
</html><?php /**PATH O:\wamp64\www\tttn-tonghop\tttn\resources\views/layout_NV.blade.php ENDPATH**/ ?>