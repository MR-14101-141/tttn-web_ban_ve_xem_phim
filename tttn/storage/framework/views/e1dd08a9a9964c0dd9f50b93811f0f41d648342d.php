        ...
        <table class="table">
            <thead class="thead-dark">
                <tr>
                    ...
                    <th scope="col"><a href="<?php echo e(URL::to('phim/create')); ?>" class="btn btn-info" role="button">+ Tạo phim</a></th>
                </tr>
            </thead>
            <tbody>
...
<?php echo $__env->make('layout_NV', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp64\www\tttn-web_ban_ve_xem_phim\tttn\resources\views/NV/dsphim.blade.php ENDPATH**/ ?>