...
<body>
        ...
        <nav class="navbar navbar-expand-lg px-4 py-2 bg-white shadow">
            ...
            <ul class="ml-auto d-flex align-items-center list-unstyled mb-0">
                ...
                <li class="nav-item dropdown ml-auto"><a id="userInfo" href="http://example.com" data-toggle="dropdown"
                    ...
                    <div aria-labelledby="userInfo" class="dropdown-menu"><a href="<?php echo e(URL::to('/profileadmin',Session::get('idNV'))); ?>" class="dropdown-item"><strong
    ...
    </html><?php /**PATH D:\wamp64\www\tttn-web_ban_ve_xem_phim\tttn\resources\views/layout_NV.blade.php ENDPATH**/ ?>