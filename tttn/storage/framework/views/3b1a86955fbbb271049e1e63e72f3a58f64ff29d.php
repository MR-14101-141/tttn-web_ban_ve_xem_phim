        ...
        <div class="col-md-6">
            <table class="table">
                ...
                <tr>
                    <td>Password</td>
                    <td>:</td>
                    <td><a href="<?php echo e(URL::to('/change-passwordadmin')); ?>">Change</a></td>
                </tr>
                <tr>
                    <td>Tên</td>
                    <td>:</td>
...
<?php echo $__env->make('layout_NV', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH O:\wamp64\www\tttn-tonghop\tttn-web_ban_ve_xem_phim\tttn\resources\views/NV/profileNV.blade.php ENDPATH**/ ?>