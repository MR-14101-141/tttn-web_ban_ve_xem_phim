    ...
    <div class="card">
        <div class="card-body">
            <form action="<?php echo e(URL::to('phim/' . $phim->idPhim . '/update')); ?>" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label>Tóm tắt</label>
                    <input type="text" value="<?php echo e($phim->mieutaPhim); ?>" class="form-control" name="mieutaPhim">
                </div>
                <div class="form-group">
...
<?php echo $__env->make('layout_NV', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp64\www\tttn-web_ban_ve_xem_phim\tttn\resources\views/NV/frmphimedit.blade.php ENDPATH**/ ?>