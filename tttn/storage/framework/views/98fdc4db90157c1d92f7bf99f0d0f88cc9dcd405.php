            ...
            <table class="table">
                <thead class="thead-dark">
                    <tr>
                        ...
                        <th scope="col"><a href="<?php echo e(URL::to('lichchieu/create')); ?>" class="btn btn-info" role="button">+ tao
                                lichchieu</a></th>
                    </tr>
                </thead>
                <tbody>
...
<?php echo $__env->make('layout_NV', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH O:\wamp64\www\tttn-tonghop\tttn-web_ban_ve_xem_phim\tttn\resources\views/NV/dslichchieu.blade.php ENDPATH**/ ?>